...
#
# Generated by export_simulation on Thu May 03 16:17:46 +0800 2018
#
################################################################################
...
switch to the './rx_word_fifo.sh' script.

./rx_word_fifo.sh -reset_run
...
./rx_word_fifo.sh -noclean_files

For more information on the script, please type './rx_word_fifo.sh -help'.
