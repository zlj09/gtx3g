...
#
# Generated by export_simulation on Wed May 09 22:45:27 +0800 2018
#
################################################################################
...
switch to the './async_dual_port_bram.sh' script.

./async_dual_port_bram.sh -reset_run
...
./async_dual_port_bram.sh -noclean_files

For more information on the script, please type './async_dual_port_bram.sh -help'.
